...
// Dont include the header files for these classes
...
class HelpDialogSpikeBandFilter;
...
private slots:
    ...
    void changeSpikeBandFilter(int spikeBandFilterIndex);
...
private:
    ...
    HelpDialogSpikeBandFilter *helpDialogSpikeBandFilter;
    ...
    QToolButton *helpDialogSpikeBandFilterButton;
    ...
    QComboBox *spikeBandFilterComboBox;
